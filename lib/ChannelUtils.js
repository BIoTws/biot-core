...
exports.check1Contract = (channel, shared_address, arrDefinition, transferAmount = 0, isRecipient) => {
	...
	if (arrDefinition[1][0][1][0][1][0][1] !== channel.peerClosingAddress) {
		return {status: false, code: 1};
	}

	if (arrDefinition[1][0][1][0][1][1][1] !== channel.myClosingAddress) {
		return {status: false, code: 2};
	}
	...
	if (arrDefinition[1][1][1][0][1] !== channel.myClosingAddress) {
