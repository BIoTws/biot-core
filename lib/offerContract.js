	...
	return new Promise((resolve, reject) => {
		...
		let arrDefinition = ['or', [
			...
			['or', [
				['and', [
					['address', myAddress],
					['hash', {hash: crypto.createHash("sha256").update(contract.secrets['r.2.0.1'], "utf8").digest("base64")}]
				]],
				['and', [
					['address', contract.peerAddress],
					['hash', {hash: crypto.createHash("sha256").update(contract.secrets['r.2.1.1'], "utf8").digest("base64")}]
				]]
			]]
		]];
